...
### DV ###
# Local
export DV_UVMA_CLK_SRC_PATH=${PROJECT_DV_DIR}/uvma_clk/src
export DV_UVME_CLK_ST_SRC_PATH=${PROJECT_DV_DIR}/uvme_clk_st/src
export DV_UVMT_CLK_ST_SRC_PATH=${PROJECT_DV_DIR}/uvmt_clk_st/src
